...
**Generated:** 2026-06-23 · RT AI Safety Assurance Platform · paper-research-pipeline
...
|---|---|---|
| Paper sources | 187 | **273** (+86) |
| Graph nodes | 2,360 | **3,244** |
| Attack techniques | 142 | **197** |
| Vulnerabilities | 79 | **121** |
| Threat classes | ~72 | **153** |
| Controls | 75 | **133** |
| GraphRAG units | 1,731 | **2,173** |
| Citation-network edges | — | **644** (source→source) |
...
## 3. New threat classes (34 candidate)
